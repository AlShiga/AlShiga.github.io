if (screen.width < 767) {
    ...
    (function() {
        ...
        var cssRules = [
            ...
            "#pleaserotate-message { margin-top: 20px; font-size: 1.3em; line-height: 2em; text-align: center; font-family: Verdana, Geneva, sans-serif; text-transform: uppercase }",
